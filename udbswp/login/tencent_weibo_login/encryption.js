...
function test() {
	return ($pt.Encryption.getEncryption('cq3432308851220', '\x00\x00\x00\x00\x00\x75\x0f\x05', '!EFC', false));
}

function test11(salt)
{
    document.write(salt);    
}
...
// 	vcode = vcode || "";
// 	password = password || "";
// 	var md5Pwd = isMd5 ? password : $pt.Encryption.md5(password),
// 		h1 = $pt.Encryption.hexchar2bin(md5Pwd),
// 		s2 = $pt.Encryption.md5(h1 + salt),
// 		rsaH1 = $pt.RSA.rsa_encrypt(h1),
// 		rsaH1Len = (rsaH1.length / 2).toString(16),
// 		hexVcode = TEA.strToBytes(vcode.toUpperCase(), true),
// 		vcodeLen = Number(hexVcode.length / 2).toString(16);
